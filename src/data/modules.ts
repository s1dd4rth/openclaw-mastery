                        ...
                        checks: [
                            {
                                ...
                                verifyPrompt:
                                    'Run `openclaw skills list` for this workspace. Respond ONLY with this JSON: {"checks":[{"id":"validator-installed","pass":true,"detail":"openclaw-mastery v0.1.0-alpha.1 installed (source: workspace)"}]} — set pass to false if openclaw-mastery is missing from the list.',
                                failHint:
