                        ...
                        checks: [
                            {
                                ...
                                failHint:
                                    'Skill not in the list. Three things to check: (1) did the git clone target the right workspace dir? (`ls ~/.openclaw/workspaces/` to confirm). (2) Did you start a fresh session after cloning? Workspace skills load at session start. (3) Does the cloned path end in `skills/openclaw-mastery/SKILL.md`?',
                                fixPrompt:
                                    'Tell the Claw: "Run `ls ~/.openclaw/workspaces/` and tell me the agent directory names. Then re-clone https://github.com/s1dd4rth/openclaw-mastery-skill into <that-agent-dir>/skills/openclaw-mastery, start a fresh session, and confirm with `openclaw skills list`."',
                            },
                        ],
                    },
                },
